/*
 * Copyright 2021 u-blox AG. All rights reserved.
 *
 * PROTECTED SOURCE CODE Ð PROPRIETARY AND CONFIDENTIAL.
...
#ifndef PPL_Version_H
#define PPL_Version_H

#ifdef __cplusplus
extern "C" {
#endif

/* Allows identifying the SDK version in the library and at runtime */
extern const char PPL_SDK_Version[];

/* Allows identifying the SDK version at compile time */
#define PPL_SDK_VERSION "Point_Perfect_SDK-ESP32-BLD21-v1.11.4"
